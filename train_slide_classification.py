...
from nn_archs.deepmil import DeepMil, GatedDeepMil
...
def train(run_name, nr_epochs, batch_size, lr, wd, experiments_dir, wandb_key, test_mode):
    ...
    model = SlideGradeModel(model='st', exp_dir=experiments_dir, run_dir=os.path.join(experiments_dir, run_name))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--nr_epochs", type=int, default=500, help="the number of epochs")
    parser.add_argument("--batch_size", type=int, default=512, help="the size of mini batches")
