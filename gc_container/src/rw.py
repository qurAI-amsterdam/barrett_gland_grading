...
From: https://github.com/DIAGNijmegen/pathology-tiger-algorithm-example/blob/29dfa266451f5bb60041cae3bd30ce999ac0220a/tigeralgorithmexample/rw.py
"""
...
class DetectionWriter:
    ...
    def write_detections(self, detections: List[tuple], spacing: tuple, x_offset: Union[int, float],
